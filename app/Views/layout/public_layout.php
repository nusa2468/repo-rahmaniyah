    ...
    <nav x-data="{ mobileMenuOpen: false }" 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="<?= base_url('/') ?>#berita" class="text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Berita</a>
                    <a href="<?= base_url('/') ?>#info" class="text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Pengumuman</a>
                    <a href="<?= base_url('portal/ppdb/home') ?>" class="text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors">PPDB Login</a>
                    <a href="<?= base_url('portal/ppdb/register') ?>" class="text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors">PPDB Daftar</a>
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="px-4 pt-2 pb-6 space-y-2">
                ...
                <a href="<?= base_url('portal/ppdb/home') ?>" class="block px-3 py-3 rounded-xl text-base font-medium hover:bg-blue-50 dark:hover:bg-gray-800 transition-colors">PPDB Online</a>
                <div class="pt-2">
